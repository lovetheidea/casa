const templates = [
  ...
  },
  {
    id: "wishlist-icon",
    template: `
    <svg class="wk-icon__svg" width="100%" height="100%" xmlns="http://www.w3.org/2000/svg" width="25" height="22" viewBox="0 0 25 22" fill="none">
    <path d="M6.72013 1C3.591 1 1.05347 3.48521 1.05347 6.55134C1.05347 9.02646 2.04513 14.9008 11.8065 20.839C11.9814 20.9443 12.1821 21 12.3868 21C12.5915 21 12.7922 20.9443 12.9671 20.839C22.7285 14.9008 23.7201 9.02646 23.7201 6.55134C23.7201 3.48521 21.1826 1 18.0535 1C14.9243 1 12.3868 4.36445 12.3868 4.36445C12.3868 4.36445 9.84927 1 6.72013 1Z" stroke="#1D5476" stroke-width="2" stroke-linecap="round" stroke-linejoin="round"/>
    </svg>
    `,
  },
  {
